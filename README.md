...
*(Puedes añadir aquí capturas de pantalla si lo deseas)*

## 👨‍💻 Autor

Desarrollado como proyecto demostrativo para portafolio profesional. Cumple con todos los criterios de aceptación especificados.
